...
export default function MareedLanding() {
  ...
  useEffect(() => {
    if (!ready) return;
    const options = mareedSubtitles(lang as MareedLang);
    ...
    >
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", display: "flex", flexDirection: "column", padding: "24px 24px 40px", position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: 8 }}>
          <HelpButton game="mareed" lang={lang} />
          <button
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 14 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, direction: "ltr" }}>
            <div style={{ width: 168, height: 168, borderRadius: 30, overflow: "hidden", border: "3px solid var(--icon-outline)", boxShadow: "5px 5px 0 var(--icon-outline)", margin: "0 auto" }}><MareedArt size={168} /></div>
          </div>
          <h1
            className="font-display"
            style={{
              fontSize: 48, fontWeight: 800, margin: 0,
              color: "#FF2E93", textShadow: "3px 3px 0 #7C3AED",
            }}
          >
            {t.gameNameArabic}
          </h1>
