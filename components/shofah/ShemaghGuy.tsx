...
// collide with NiqabGirl's defs when both render on the same page (the
...
export default function ShemaghGuy({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 240 250" className={`shofah-float ${className}`}>
      ...
      <g className="shofah-blink" style={{ transformOrigin: "120px 112px" }}>
      ...
      <g fill="#FFC93C">
        <path className="shofah-twinkle" d="M32 76 l3 8 8 3 -8 3 -3 8 -3-8 -8-3 8-3z" />
        <path className="shofah-twinkle-b" d="M208 118 l2 6 6 2 -6 2 -2 6 -2-6 -6-2 6-2z" />
      </g>
    </svg>
  );
}
