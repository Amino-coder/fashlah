...
// collide with PatientGuy's defs when both render on the same page (the
...
export default function PatientGirl({
  size = 140,
  className = "",
}: {
  size?: number;
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 240 250" className={`mareed-float ${className}`}>
      ...
      <g className="mareed-blink" style={{ transformOrigin: "120px 116px" }}>
      ...
      <path className="mareed-twinkle" d="M204 70 Q204 60 212 60 Q220 60 220 70 Q220 82 204 94 Q188 82 188 70 Q188 60 196 60 Q204 60 204 70" fill="#F4708F" opacity=".75" />
      <g fill="#FFC93C">
        <path className="mareed-twinkle-b" d="M26 92 l3 8 8 3 -8 3 -3 8 -3-8 -8-3 8-3z" />
        <path className="mareed-twinkle" d="M32 160 l2 5 5 2 -5 2 -2 5 -2-5 -5-2 5-2z" />
      </g>
    </svg>
  );
}
