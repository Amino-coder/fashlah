...
export const LIFOO_STR: Record<LifooLang, Record<string, string>> = {
  ar: {
    ...
    shatr1Ph: "السطر الأول...",
    shatr2Ph: "السطر الثاني...",
    customOpeningConfirm: "ابدأ الأغنية",
    poetLabel: "الفنان",
    writtenByLabel: "بقلم",
    shatr1Label: "السطر الأول",
    shatr2Label: "السطر الثاني",
  ...
  en: {
    ...
    shatr1Ph: "First line...",
    shatr2Ph: "Second line...",
    customOpeningConfirm: "Start the song",
    poetLabel: "Artist",
    writtenByLabel: "Written by",
    shatr1Label: "First line",
    shatr2Label: "Second line",
    // Round writing
