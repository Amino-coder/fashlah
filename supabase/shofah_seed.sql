-- ============================================================================
-- SHOFAH — question bank seed (48 prompts across 7 categories)
...
-- Opening
('opening', 'بهرني بالضبط ب6 كلمات.', 'Impress me in exactly 6 words.'),
...
('opening', 'اوصف نفسك كانك تسوي دعاية لسيارة تبي تبيعها.', 'Describe yourself like you''re selling a used car.'),
...
('getting_to_know_you', 'وش أكثر شي تحس فيه بعدم الثقة؟', 'What''s your biggest insecurity?'),
('getting_to_know_you', 'وش الشي اللي أهلك يحذرونك منه؟', 'What''s one thing your family warns people about?'),
...
('career_money', 'ليش لين الحين ما طردوك من وظيفتك؟', 'Why haven''t you been fired yet?'),
('career_money', 'لو بحثت عن اسمك في قوقل، وش بلقى؟', 'If I Googled your name, what would I find?'),
('career_money', 'وش أسرع طريقة تصير فيها غني؟', 'What''s the fastest way you could become rich?'),
('career_money', 'اقنعني إنك مو ريد فلاق.', 'Convince me your career isn''t a red flag.'),

-- Lifestyle
('lifestyle', 'اوصف ليلة الجمعة المثالية عندك.', 'Describe your ideal Friday night.'),
('lifestyle', 'وش أغلى شي تسويه؟', 'What''s your most expensive bad habit?'),
('lifestyle', 'لو سافرنا بكره، بنروح وين؟', 'If we went on vacation tomorrow, where are we going?'),
...
('awkward', 'ليش فشلت علاقتك اللي راحت؟ (قول شي حتى لو ما عندك جواب.)', 'Why did your last relationship fail? (Make something up if needed.)'),

-- Marriage
('marriage', 'ليش لازم أتزوجك؟', 'Why should I marry you?'),
('marriage', 'اقنع أهلي بجملة وحدة.', 'Convince my parents in one sentence.'),
('marriage', 'كمل الجملة: "الحياة معاي بتكون..."', 'Finish this sentence: "Life with me will be..."'),
('marriage', 'وش بيكون أول خلاف بيننا؟', 'What''s our first argument going to be about?'),
...
-- Wildcards
('wildcard', 'جاوب بس بالإيموجيات.', 'Reply using only emojis.'),
('wildcard', 'قول غزل يفشل.', 'Use a pickup line so bad it becomes good.'),
('wildcard', 'قول شي يخليني أرفضك على طول.', 'Make me reject you immediately.'),
('wildcard', 'ابهرني بكذبة واضحة.', 'Impress me while clearly lying.'),
...
('wildcard', 'اقنعني إنك مو غريب.', 'Convince me you''re definitely not suspicious.'),
